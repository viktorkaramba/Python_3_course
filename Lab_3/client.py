...
print(client.add_goods(17, 4, 'Net', 499.99, 'Football'))
print(client.get_all_goods_by_section(1))
print(client.get_goods_by_name('Net'))
print(client.edit_goods(17, 1, 9))
print(client.get_all_goods_by_section(4))
print(client.add_goods(10, 1, 'Samsung Galaxy A71', 299.99, 'smartphone'))
print(client.get_all_goods_by_section(1))
print(client.count_goods_by_section(1))
print(client.delete_goods(10))
print(client.get_all_goods_by_section(1))
